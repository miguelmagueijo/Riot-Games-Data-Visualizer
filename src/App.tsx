...
function App() {
	return (
		<div className="max-w-4xl mx-auto space-y-4 py-4">
			<Navbar />
			{/* Drop file area */}
			<div id="dropArea" className="border-4 border-dashed border-white/70 rounded py-8 flex justify-center items-center space-y-4 flex-col bg-white/10">
				...
				<span className="text-xs font-semibold text-white/50">Drop or choose .zip file</span>
			</div>
			{/* Tabs */}
			<div>
